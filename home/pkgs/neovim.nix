    ...
    linkFarm "zig-packages" [
      {
        ...
        path = fetchzip {
          url = "https://github.com/kristoff-it/zig-lsp-kit/archive/b4bf61d7fbf9cf7cfdb6f01b211947d2de3e42fd.tar.gz";
      ...
      }
      {
        ...
        path = fetchzip {
          url = "https://github.com/kristoff-it/scripty/archive/df8c11380f9e9bec34809f2242fb116d27cf39d6.tar.gz";
      ...
      }
      {
        ...
        path = fetchzip {
          url = "https://github.com/kristoff-it/zig-afl-kit/archive/f003bfe714f2964c90939fdc940d5993190a66ec.tar.gz";
      ...
      }
      {
        ...
        path = fetchzip {
          url = "https://github.com/allyourcodebase/AFLplusplus/archive/032984eabf5a35af386a3d0e542df7686da339c1.tar.gz";

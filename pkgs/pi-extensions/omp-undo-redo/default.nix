...
buildNpmPackage {
  pname = "omp-undo-redo";
  version = "1.3.3-unstable-2026-08-14";

  src = fetchFromGitHub {
    owner = "Baylar55";
    repo = "omp-undo-redo";
    rev = "63aeac73a19885a23bb6db32a5e745cd11cad416";
    hash = "sha256-0C3rvj3LDt/8NuleIkeDeQQT+Q0yiEUQZv3GA+W+vXw=";
  };

  nodejs = nodejs_24;
  npmDepsHash = "sha256-frYsErH6JrKnXB/XfyZPP5LpV27pl33Pmr8ppCYSJys=";

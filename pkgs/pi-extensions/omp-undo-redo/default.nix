...
buildNpmPackage {
  pname = "omp-undo-redo";
  version = "1.5.6-unstable-2026-08-27";

  src = fetchFromGitHub {
    owner = "Baylar55";
    repo = "omp-undo-redo";
    rev = "05e768a3c8a66606a948ce633ae14b853cb35038";
    hash = "sha256-GaEqz/LsZrOS1IW+K9ZArPhyI5VpXuDu/uUteF/zY84=";
  };

  nodejs = nodejs_24;
  npmDepsHash = "sha256-Prpuy9Kr9uMiwdhJQy6CEz0+fMdntEwpMxoVyINOKeQ=";

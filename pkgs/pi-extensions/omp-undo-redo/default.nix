...
buildNpmPackage {
  pname = "omp-undo-redo";
  version = "1.5.1-unstable-2026-08-21";

  src = fetchFromGitHub {
    owner = "Baylar55";
    repo = "omp-undo-redo";
    rev = "665f0fff0971a7b04c35234dd7f087abaa696a75";
    hash = "sha256-mLmFf7MKZYZGvzeWR9WN7nzu1HEB3mc7xPTaaK6TEmM=";
  };

  nodejs = nodejs_24;
  npmDepsHash = "sha256-sFJtAwEn2j+j5nq9MWJbuLm0nsjm6ozZvIOd9FjXGTk=";

...
buildNpmPackage {
  pname = "omp-undo-redo";
  version = "1.6.2-unstable-2026-09-21";

  src = fetchFromGitHub {
    owner = "Baylar55";
    repo = "omp-undo-redo";
    rev = "c534bdac8eb9e02a51d99657ad53c2047554a8b1";
    hash = "sha256-MgRQFv/IEAKMxL4vH09RymZ97srG3+8Nlde3yYtcec8=";
  };

  nodejs = nodejs_24;
  npmDepsHash = "sha256-0MMBvLfD5qHQuFMrP4JxXgPXrP7GY9my9PO5kw9dTMw=";

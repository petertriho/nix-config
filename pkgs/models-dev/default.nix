...
stdenvNoCC.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    owner = "sst";
    repo = "models.dev";
    rev = "695ad2e6485a254497d6f6b110f4323493ac197d";
    sha256 = "sha256-dI18PXxETWouK/EgaAVvQRB8OL465OD163wJEMYF6B0=";
  };
    ...
    outputHash =
      {
        ...
        aarch64-linux = "sha256-Uajwvce9EO1UwmpkGrViOrxlm2R/VnnMK8WAiOiQOhY=";
        x86_64-darwin = "sha256-IM88XPfttZouN2DEtnWJmbdRxBs8wN7AZ1T28INJlBY=";

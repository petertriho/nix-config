...
stdenv.mkDerivation (finalAttrs: {
  pname = "open-design";
  version = "pr-3706-verification-assets-unstable-2026-06-16";

  src = fetchFromGitHub {
    owner = "nexu-io";
    repo = "open-design";
    rev = "c7e422d7a2d3047a4252575afb0ea922e7757037";
    hash = "sha256-za+KYVohL5/rAD5zTW6k0OD/BtRPXr7n7kJNhZBqP3g=";
  };

...
stdenv.mkDerivation (finalAttrs: {
  pname = "open-design";
  version = "pr-3706-verification-assets-unstable-2026-06-11";

  src = fetchFromGitHub {
    owner = "nexu-io";
    repo = "open-design";
    rev = "716c2f2ad90876aba14606dac1f9096c8f16c928";
    hash = "sha256-jPOoMDkmJTlWxpYEJYH44dGwXOHDsA1HiXhXvE5uoOE=";
  };

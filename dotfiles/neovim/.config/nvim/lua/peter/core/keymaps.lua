...
keymap("", "<leader>Xc", ":!<Up><CR>", { desc = "Last Command" })
keymap("", "<leader>Xe", ":!chmod +x %<CR>", { desc = "Executable" })
keymap("n", "<leader>Xp", 'ggVG"+p', { desc = "Put File" })
keymap("n", "<leader>Xy", "<CMD>%y+<CR>", { desc = "Yank File" })
keymap("x", "<leader>Xp", [["_dP]], { desc = "Put_" })

require("peter.plugins.lazypack").setup({
	{ import = "peter.plugins.specs.ui" },
	{ import = "peter.plugins.specs.ai" },
	{ import = "peter.plugins.specs.lsp" },
	{ import = "peter.plugins.specs.completion" },
